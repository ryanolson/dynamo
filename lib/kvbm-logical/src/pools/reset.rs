...
/// Default FIFO [`BlockAllocator`] backed by a [`VecDeque`].
///
/// Blocks are returned in first-in-first-out order. This is the allocator
/// used by [`BlockManager`](crate::BlockManager) when no custom allocator is
/// provided.
#[derive(Debug)]
